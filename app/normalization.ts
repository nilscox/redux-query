...
export const commentSchema = new schema.Entity('comment', { author: userSchema });
commentSchema.define({ replies: [commentSchema] });

export const threadSchema = new schema.Entity('thread', { author: userSchema, comments: [commentSchema] });
